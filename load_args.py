...
def load_args():
    ...
    parser.add_argument("--ckpt_path", type=int, default=44, help="path to load checkpoints")
    ...
    parser.add_argument("--data_path", type=str, default="../data/data.txt", help="data")
    parser.add_argument("--load_dataset_path", type=str, default="../data/merged_samples.pt", help="dataset")
    parser.add_argument("--proj_name", type=str, default="nnp", help="data")
    parser.add_argument("--rank", type=str, default="0", help="gpu rank")
    parser.add_argument("--qat", action="store_false", help="qat")
    parser.add_argument("--fp8", action="store_false", help="float 8bit")
